  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="<?php echo base_url() ?>report">Report DR SMS</a></div>
      </div>
    </div>
  ...
  $(document).ready( function () {
    ...
    $('#search').on('click',function(){
      ...
      $('#myTable').dataTable( {  
        ...
        bServerSide: true,
        "ajax": {    
          "url": "<?php echo base_url() ?>/reportdr/ajax_data",    
          "type": "POST",
          "data": {
            tanggal: $("#tanggal").val(),
      ...
      $('#download').show();
      $('#download').attr('href', 'reportdr/download?tanggal=' + tanggal + '&username=' + username );
    });
