...
<?php
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/owlcarousel2/dist/assets/owl.theme.default.min.css">
<?php
}elseif ($this->uri->segment(1) == "forms_advanced_form" || $this->uri->segment(1) == "sms") { ?>
...
<?php
}elseif ($this->uri->segment(1) == "priviledge" || $this->uri->segment(1) == "users" || $this->uri->segment(1) == "client" || $this->uri->segment(1) == "data" || $this->uri->segment(1) == "report" || $this->uri->segment(1) == "reportdr" || $this->uri->segment(1) == "modules_datatables") { ?>
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/bootstrap-daterangepicker/daterangepicker.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/bootstrap-timepicker/css/bootstrap-timepicker.min.css">
...
<?php
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/jquery-selectric/selectric.css">
<?php
}elseif ($this->uri->segment(1) == "features_profile" || $this->uri->segment(1) == "profile") { ?>
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/bootstrap-social/bootstrap-social.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/summernote/summernote-bs4.css">
<?php
...
}elseif ($this->uri->segment(1) != "" && $this->uri->segment(1) != "auth" && $this->uri->segment(1) != "auth_login" && $this->uri->segment(1) != "auth_forgot_password"&& $this->uri->segment(1) != "auth_register" && $this->uri->segment(1) != "auth_reset_password" && $this->uri->segment(1) != "errors_503" && $this->uri->segment(1) != "errors_403" && $this->uri->segment(1) != "errors_404" && $this->uri->segment(1) != "errors_500" && $this->uri->segment(1) != "utilities_contact" && $this->uri->segment(1) != "utilities_subscribe") {
